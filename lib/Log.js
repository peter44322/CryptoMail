...
class Log {
  ...
  log() { //handle the input line
    ...
    for (
      ...
      i < len;
      i++ //use argument variable to print the input stream
    ) {
      console.log(arguments[i]);
    }
    askUser(); //this functin read the user message
    const askUser = async () =>
      //synchronization function to handle the input
      {
        this.rl = readline.createInterface(
          // create an interface to ask for entering data
          {
            input: process.stdin,
        ...
        this.rl.question("Send message: ", function(
          message // ask to enter a message
        ) {
